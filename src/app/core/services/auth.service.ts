...
export class AuthService {
        ...
        tap(response => {
          ...
          if (token) {
            ...
            try {
              ...
              userRole = decoded.role || decoded.Rol || decoded.user_role || RolUsuario.USER;
  ...
  /**
   * Obtiene el usuario completo descifrado
   */
  getUser(): User | null {
  ...
  /**
   * Obtiene el rol directamente del localStorage (sin descifrar)
   */
