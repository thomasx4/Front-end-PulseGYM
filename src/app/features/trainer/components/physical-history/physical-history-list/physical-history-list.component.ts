...
export class PhysicalHistoryListComponent implements OnInit {
 ...
 onNewMedicion(): void {
    this.router.navigate(['/trainer/physical-history/new']);
  }
  ...
  onViewDetail(id: number): void {
    ...
    this.router.navigate(['/trainer/physical-history/detail', validId]);
  }
  ...
  onEdit(id: number): void {
    ...
    this.router.navigate(['/trainer/physical-history/edit', validId]);
  }
  onBack(): void {
